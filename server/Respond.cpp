...
/*   Updated: 2021/07/24 11:27:05 by pgoudet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Respond::operator=(const Respond &Resp)
{
	...
	this->_contentLength = Resp._contentLength;
...
void		Respond::setContentLength(std::string length){ this->_contentLength = length; }
...
std::string	Respond::getContentLength() const { return (this->_contentLength); }
...
int			Respond::finalRespond(int fd, t_request &parsedRequest, char **env, WebservData &Data)
{
	...
	std::cout << "VAL: " << getStatusCode() << getStatusMessage() << std::endl;
